...
namespace Google.PubSub.Client.Web.Controllers
{
    public class SubscriptionController : Controller
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            await CreateSubscriptionAsync(client, subscriptionId, topicName, projectId, retryPolicy, minBackoff, maxBackoff, cancellationToken);
            ...
            CancellationToken cancellationToken)
        {
            ...
            var subscription = await client.GetSubscriptionAsync(subscriptionId, cancellationToken);
